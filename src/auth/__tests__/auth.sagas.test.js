...
import { checkAuth, getAuthenticatedState, login, loginWithToken, refreshToken } from '../auth.sagas'
import { getAccessToken, login as loginService, ping, refreshToken as refreshTokenService } from '../auth.service'
...
describe('login saga', () => {
  describe('login successfully', () => {
    ...
    it('should call saga loginWithToken', () => {
      expect(generator.next(response).value).toEqual(call(loginWithToken, response))
    })
    it('should be done', () => {
...
describe('loginWithToken saga', () => {
  ...
  describe('login with success', () => {
    ...
    it('should call setRefreshToken', () => {
      expect(generator.next().value).toEqual(call(setRefreshToken, refresh_token))
    })
    it('should call loginService', () => {
      expect(generator.next().value).toEqual(call(loginService, access_token))
    })
    it('should call setToken', () => {
      expect(generator.next(loginResponse).value).toEqual(call(setToken, token))
    })
...
describe('refreshToken saga', () => {
  describe('refreshToken with success', () => {
    ...
    it('should call refreshToken service', () => {
      expect(generator.next(refresh_token).value).toEqual(call(refreshTokenService, refresh_token))
    })
    it('should call loginWithToken', () => {
      expect(generator.next(refreshTokenResponse).value).toEqual(call(loginWithToken, refreshTokenResponse))
    })
