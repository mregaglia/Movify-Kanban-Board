...
export const getDetailData = (id, data, type, weekLabel, clientOrCandidate, clientId = null) => ({
  ...
  payload: {
    ...
    CLIENT_OR_CANDIDATE: clientOrCandidate,
    CLIENT_ID: clientId,
  },
})

export const setDataExpandView = (type, weekLabel, detailString) => ({
  type: SET_DATA_EXPAND_VIEW,
  payload: { TYPE: type, WEEK_LABEL: weekLabel, DETAIL_STRING: detailString },
})
