...
import { INITIALIZE_EXPAND_VIEW, SET_DATA_EXPAND_VIEW } from './expandView.action'
...
const expandView = {
  ...
  [INITIALIZE_EXPAND_VIEW]: (state) => ({
    ...
    CV_SENT: objectByDates,
  }),
}

export default (state, action) => bindReducer(state, action, expandView, initialState)
