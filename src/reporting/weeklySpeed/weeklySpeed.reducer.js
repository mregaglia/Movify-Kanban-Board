...
import { INITIALIZE_STATE_WEEKLY_SPEED_CALCUL, SET_GAUGE_LIMIT, SET_WEEKLY_SPEED } from './weeklySpeed.action'
...
export default (state, action) => bindReducer(state, action, weeklySpeed, initialState)
