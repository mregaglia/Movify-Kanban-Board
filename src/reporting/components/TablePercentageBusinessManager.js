...
export default connect(
  (state) => ({
    dataConversionYTD: pathOr(
      {},
      ["kpi", "dataYTDEmployee", "CONVERSION_YTD_BM"],
      state
    ),
    dataTotalYTD: pathOr({}, ["kpi", "dataYTDEmployee", "TOTAL_YTD_BM"], state),
    dataAverageYTD: pathOr(
      {},
      ["kpi", "dataYTDEmployee", "AVERAGE_YTD_BM"],
      state
    ),
    isLoadingConversionYTD: pathOr(
      {},
      ["kpi", "isLoadingYTDConversion"],
      state
    ),
    isLoadingTotalYTD: pathOr({}, ["kpi", "isLoadingYTDTotal"], state),
    isLoadingAverageYTD: pathOr({}, ["kpi", "isLoadingYTDAverage"], state),
    isLoadingYTDNewVacancy: pathOr(
      {},
      ["kpi", "isLoadingYTDNewVacancy"],
      state
    ),
    isLoadingYTDConversionNewVacancy: pathOr(
      {},
      ["kpi", "isLoadingYTDConversionNewVacancy"],
      state
    ),
    isLoadingYTDCVSent: pathOr({}, ["kpi", "isLoadingYTDCVSent"], state),
    isLoadingYTDConversionCVSent: pathOr(
      {},
      ["kpi", "isLoadingYTDConversionCVSent"],
      state
    ),
  }),
  {}
