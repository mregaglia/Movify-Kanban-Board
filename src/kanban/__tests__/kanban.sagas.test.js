...
describe('getBms saga', () => {
  describe('getBms saga with success and load more', () => {
    ...
    it('should get bms list from response', () => {
      expect(generator.next(bmsResponse).value).toEqual(call(propOr, [], 'data', bmsResponse))
    })
    ...
    it('should getJobOrders for all bms', () => {
      expect(generator.next().value).toEqual(all(bmList.map((bm) => put(getJobOrdersAction(prop('id', bm))))))
    })
    ...
    it('should put updatePriorityFilter', () => {
      expect(generator.next().value).toEqual(put(updatePriorityFilter()))
    })
...
describe('getClientCorporations saga', () => {
  ...
  it('should put updateClientCorporations', () => {
    expect(generator.next(ccs).value).toEqual(put(updateClientCorporations(ccs)))
  })
  it('should put updateBms', () => {
...
describe('getJobOrders saga', () => {
  describe('getJobOrders saga with success and load more', () => {
    ...
    it('should call getJobOrders service', () => {
      expect(generator.next().value).toEqual(call(getJobOrdersService, bmId, 0))
    })
    it('should get jobOrders list from response', () => {
      expect(generator.next(jobOrdersResponse).value).toEqual(call(propOr, [], 'data', jobOrdersResponse))
    })
    it('should call getClientCorporations saga', () => {
      expect(generator.next(jobOrderList).value).toEqual(call(getClientCorporations, bmId, jobOrderList))
    })
    ...
    it('should put updateClientCorporations', () => {
      expect(generator.next().value).toEqual(put(updateClientCorporations(ccs)))
    })
    it('should put getJobSubmissions action on each jobOrder', () => {
      expect(generator.next().value).toEqual(
        all(
          jobOrderList.map((jobOrder) =>
            put(getJobSubmissionsAction(bmId, path(['clientCorporation', 'id'], jobOrder), prop('id', jobOrder)))
          )
        )
      )
    })
...
describe('getJobSubmissions saga', () => {
  describe('getJobSubmissions saga with success and load more', () => {
    ...
    it('should call getJobSubmissions', () => {
      expect(generator.next().value).toEqual(call(getJobSubmissionsService, joId, 0))
    })
    it('should reduce jobSubmissions', () => {
      expect(generator.next(jobSubmissionsResponse).value).toEqual(all(jobSubmissions))
    })
    it('should put updateJobSubmissions', () => {
      expect(generator.next(jobSubmissions).value).toEqual(put(updateJobSubmissions(jobSubmissions)))
    })
    it('should put updateJobOrders', () => {
      expect(generator.next().value).toEqual(put(updateJobOrders(jobOrders)))
    })
    it('should load more', () => {
      expect(generator.next().value).toEqual(call(getJobSubmissions, action, 2))
    })
    it('should be done', () => {
      expect(generator.next()).toEqual({ done: true, value: undefined })
    })
  ...
  describe('getJobSubmissions saga with success and no load more', () => {
    ...
    it('should call getJobSubmissions', () => {
      expect(generator.next().value).toEqual(call(getJobSubmissionsService, joId, 4))
    })
    it('should reduce jobSubmissions', () => {
      expect(generator.next(jobSubmissionsResponse).value).toEqual(all(jobSubmissions))
    })
...
describe('updateJobSubmission saga', () => {
  describe('updateJobSubmission saga with success', () => {
    ...
    it('should call updateJobSubmissionStatus saga', () => {
      expect(generator.next().value).toEqual(call(updateJobSubmissionStatus, action))
    })
    it('should call updateJobSubmissionStatus service', () => {
      expect(generator.next().value).toEqual(call(updateJobSubmissionStatusService, joId, status))
    })
    it('should call toast success', () => {
      expect(generator.next().value).toEqual(call(toast.success, en.UPDATE_STATUS_SUCCESS))
    })
    it('should be done', () => {
      expect(generator.next()).toEqual({ done: true, value: undefined })
    })
  ...
  describe('updateJobSubmission saga with error', () => {
    ...
    it('should call updateJobSubmissionStatus saga', () => {
      expect(generator.throw().value).toEqual(call(updateJobSubmissionStatus, reverseAction))
    })
    it('should call toast error', () => {
      expect(generator.next().value).toEqual(call(toast.error, en.UPDATE_STATUS_ERROR))
    })
    it('should be done', () => {
      expect(generator.next()).toEqual({ done: true, value: undefined })
    })
...
describe('updateJobSubmissionStatus saga', () => {
  ...
  it('should put setJobSubmissions', () => {
    expect(generator.next(stateJobSubmissions).value).toEqual(put(setJobSubmissions(jobSubmissions)))
  })
  ...
  it('should get state job orders', () => {
    expect(generator.next(stateJobOrder).value).toEqual(select(getStateJobOrders))
  })
  it('should put setJobOrders', () => {
    expect(generator.next(stateJobOrders).value).toEqual(put(setJobOrders(jobOrders)))
  })
  it('should be done', () => {
    expect(generator.next()).toEqual({ done: true, value: undefined })
  })
...
describe('createJobSubmission saga', () => {
  describe('createJobSubmission saga with success', () => {
    ...
    it('should call createJobSubmission service', () => {
      expect(generator.next().value).toEqual(call(createJobSubmissionService, js))
    })
    it('should call getJobSubmission service', () => {
      expect(generator.next(creationResponse).value).toEqual(call(getJobSubmission, createdId))
    })
    it('should call addJobSubmission saga', () => {
      expect(generator.next(jsResponse).value).toEqual(call(addJobSubmission, newJs))
    })
    it('should call toast success', () => {
      expect(generator.next().value).toEqual(call(toast.success, en.CREATE_CANDIDATE_SUCCESS))
    })
    it('should be done', () => {
      expect(generator.next()).toEqual({ done: true, value: undefined })
    })
  ...
  describe('createJobSubmission saga with error', () => {
    ...
    it('should call removeTempJobSubmission saga', () => {
      expect(generator.throw().value).toEqual(call(removeTempJobSubmission, tempJs.id))
    })
    it('should call toast error', () => {
      expect(generator.next().value).toEqual(call(toast.error, en.CREATE_CANDIDATE_ERROR))
    })
    it('should be done', () => {
      expect(generator.next()).toEqual({ done: true, value: undefined })
    })
...
describe('addJobSubmission saga', () => {
  describe('addJobSubmission saga with temp', () => {
    ...
    it('should put setJobSubmissions', () => {
      expect(generator.next(stateJs).value).toEqual(put(setJobSubmissions(jss)))
    })
    it('should get state job order', () => {
