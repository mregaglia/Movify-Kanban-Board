...
export const setRefreshToken = (refreshToken) => localStorage.setItem(STORAGE_REFRESH_TOKEN, refreshToken)
export const removeRefreshToken = () => localStorage.removeItem(STORAGE_REFRESH_TOKEN)

export const getBaseUrl = () => localStorage.getItem(STORAGE_BASE_URL)
export const setBaseUrl = (baseUrl) => localStorage.setItem(STORAGE_BASE_URL, baseUrl)
