...
import { setFilteredBms, setPriorityFilter, UPDATE_PRIORITY_FILTER } from '../priorityFilter.actions'
import { getStateBmIds, getStateBms, getStateFilter, updatePriorityFilter } from '../priorityFilter.sagas'
...
describe('updatePriorityFilter saga', () => {
  ...
  it('should put put setFilteredBms', () => {
    expect(generator.next(kanbanBms).value).toEqual(put(setFilteredBms(kanbanBms)))
  })
  it('should be done', () => {
