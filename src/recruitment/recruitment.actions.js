...
export const UPDATE_RECRUITMENT_CLIENT_CORPORATIONS_IDS = 'UPDATE_RECRUITMENT_CLIENT_CORPORATIONS_IDS'
export const UPDATE_RECRUITMENT_CLIENT_CORPORATIONS = 'UPDATE_RECRUITMENT_CLIENT_CORPORATIONS'
...
export const GET_RECRUITMENT_JOB_SUBMISSIONS = 'GET_RECRUITMENT_JOB_SUBMISSIONS'
export const SET_RECRUITMENT_JOB_SUBMISSIONS = 'SET_RECRUITMENT_JOB_SUBMISSIONS'
export const UPDATE_RECRUITMENT_JOB_SUBMISSIONS = 'UPDATE_RECRUITMENT_JOB_SUBMISSIONS'
export const UPDATE_HRS = 'UPDATE_HRS'
export const UPDATE_RECRUITMENT_JOB_SUBMISSION = 'UPDATE_RECRUITMENT_JOB_SUBMISSION'
export const CREATE_RECRUITMENT_JOB_SUBMISSION = 'CREATE_RECRUITMENT_JOB_SUBMISSION'
export const DELETE_RECRUITMENT_JOB_SUBMISSION = 'DELETE_RECRUITMENT_JOB_SUBMISSION'
export const REMOVE_RECRUITMENT_JOB_SUBMISSION = 'REMOVE_RECRUITMENT_JOB_SUBMISSION'
...
export const updateJobSubmission = (prevJobOrderId, prevStatus, jobOrderId, jobSubmissionId, status) => ({
