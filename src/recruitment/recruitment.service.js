...
export const getTalentAcquisitionManagers = (start = 0) =>
  get('query/CorporateUser', {
    ...
    where:
      "occupation IN ('Talent Acquisition Manager %26 Reporting Owner', 'Talent Acquisition Manager', 'Reporting Owner %26 Talent Acquisition Manager') AND isDeleted=false",
...
export const getJobSubmissions = (jobOrderId, start = 0) =>
  post(
    ...
    {
      query: `jobOrder.id:${jobOrderId} AND isDeleted:false AND (${getFilterStatusRequest(RECRUITMENT_STATUSES)})`,
      start,
    },
    {
